...
export const statCardsRow = {
  display: 'flex', flexWrap: 'wrap', gap: '16px', marginBottom: '1.5rem',
}
...
export const pageHeader = {
  background: '#1e2b1b', padding: '28px 32px', marginBottom: '1.5rem', borderRadius: '0 0 16px 16px',
}
...
export const pageHeaderSub = {
  fontSize: '13px', color: '#8fad80', marginTop: '4px', fontFamily: 'Poppins, sans-serif',
}

// ── DoctorPage-style shell ────────────────────────────────────────────────────
...
export const adminHeroCard = {
  ...
  color: '#ffffff', boxShadow: '0 24px 60px rgba(18, 53, 36, 0.22)',
  marginBottom: '28px',
}

export const adminHeroAccent = {
  position: 'absolute', width: '220px', height: '220px', borderRadius: '999px',
  background: 'rgba(255, 255, 255, 0.12)', top: '-70px', right: '-40px',
}
...
export const adminTabRow = {
  display: 'flex', gap: '10px', flexWrap: 'wrap', margin: '0 0 20px',
}
...
export const adminTabButtonActive = {
  background: '#123524', color: '#ffffff',
